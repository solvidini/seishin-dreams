    ...
    <div className='masonry-grid'>
      {images.map((image, index) => (
        <div key={index} className='break-inside-avoid mb-4'>
          <figure onClick={() => handleImageClick(image.src, image.caption)} className='relative cursor-pointer transition-all ease-in-out duration-300 hover:scale-100 sm:hover:scale-105 hover:brightness-110'>
