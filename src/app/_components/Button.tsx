...
export const Button: FC<ButtonHTMLAttributes<HTMLButtonElement>> = ({
	...
	<div className="relative">
		<DotsSVG className="absolute fill-secondary h-[180%] -left-[10%] top-1/2 -translate-y-1/2" />
		<DotsSVG className="absolute fill-secondary h-[180%] -right-[10%] top-1/2 -translate-y-1/2" />
		<button
			type="button"
			{...props}
			className={twMerge(
